        ...
        <form action="" method="POST">
            <table class="table-30">
                ...
                <tr>
                    <td colspan="2">
                        <br>
                        <input type="submit" name="submit" value="Registeration" class="btn-update">
                    </td>
                </tr>
            </table>
        </form>
            <?php 
                ...
                ?>
                        ...
                        <script>window.location.href='http://localhost/Doctor-appointment/doctor/index.php';</script>
                        <?php
                    }
                    else
                    {
                        ...
                        header('location:'.SITEURL.'doctor/doctor_register.php');
                    }
